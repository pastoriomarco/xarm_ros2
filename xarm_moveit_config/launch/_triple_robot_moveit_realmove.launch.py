...
def launch_setup(context, *args, **kwargs):
    ...
    robot_ip_3 = LaunchConfiguration('robot_ip_3')
    ...
    baud_checkset_3 = LaunchConfiguration('baud_checkset', default=baud_checkset)
    ...
    default_gripper_baud_3 = LaunchConfiguration('default_gripper_baud', default=default_gripper_baud)
   ...
   # xarm_moveit_config/launch/_triple_robot_moveit_common2.launch.py
    robot_moveit_common_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_moveit_config'), 
    ...
    joint_state_publisher_node = Node(
        ...
        parameters=[{
            'source_list': [
                ...
                '{}{}/joint_states'.format(prefix_3.perform(context), hw_ns.perform(context))
            ], 
        }],
        remappings=[
            ...
            ('follow_joint_trajectory', '{}{}_traj_controller/follow_joint_trajectory'.format(prefix_3.perform(context), xarm_type_3)),
        ],
    )

    # ros2 control launch
    # xarm_controller/launch/_triple_ros2_control.launch.py
    ros2_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('xarm_controller'), 
